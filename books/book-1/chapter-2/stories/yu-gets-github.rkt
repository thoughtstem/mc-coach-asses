...
@paras{
  ...
  "some instructions")}
    ...
    @li{Finally, create a Github repository called "mc-coach-NAME".  But replace NAME with your actual name.  Yu's repository will be mc-coach-yu.  Match the pattern for your own repository. Here are @(link-to "https://help.github.com/en/github/getting-started-with-github/create-a-repo" "some instructions")}.
  }
