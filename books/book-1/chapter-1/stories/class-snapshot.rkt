...
@paras{
       ...
       As you walk the prestigious halls of Babbage University, you stop to admire a painting of Babbage himself, hanging on the wall.
       ...
       "Okay, so let me see if I understand.  A MetaCoders class is a sequence of alternating Story Modes and Game Modes, and the map tells you which one to do when?"

       "Daaaang," said Joseph.  "Are you sure you haven't already gone through the MetaCoders training?  Alright, since you're practically an expert, let me give you the official guidelines for Story Mode and Game Mode."  He rummages around in his pocket and finds a slip of paper that he hands to you.  It reads:

       @card{
        @b{Story Mode:}
        @ul{
          @li{one point of focus (coach, student)}
          @li{can look a lot of different ways}
          @li{lower risk/challenge for most students}
          @li{lower activity level}
        }
      ...
      "Sorry," says Joseph.  "I need it back.  But the nice thing about us both being characters in a story is that we're not going anywhere.  Metapolis is timeless.  So is Babbage University.  So is this conversation we're having.  I'll always be right here, in Chapter 1, at Babbage University, teaching this exact class every time you come back.  So as long as you remember where you learned something in Metapolis, you can always find it again."
