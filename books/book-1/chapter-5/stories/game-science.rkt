...
@paras{
  ...
  "And were you aware of those seconds?"

  "A few of them."

  "Then you were @i{not} in a flow state," he says.  He rummages in his desk and returns with a sheet of gold stars -- the kind a grade school teacher might use.  Delicately, he peels off one of them and keeps it on the end of his index finger.  "What is flow?" he asks.

  "I guess you're trying to get me to say that it's a state where you're not quite aware of the passage of time."

  He reaches across the desk to give you the gold star.  Not knowing quite what to do with it, you stick it to the back of your hand.  By the time you've done so, he has already pealed off the next one.

  "Tell me more," he says.

  "I've gathered from the coach training thus far that MetaCoders classes are alternations between Story Mode and Game Mode.  In Story Mode, coaches communicate information, ideas, and values in the form of stories and discussions -- with the ideal goal of inducing a kind of deep engagement scientists call 'narrative transporation'." He slowly begins to extend the gold star to you.  You go on, encouraged: "I'm guessing that in Game Mode, we do the same thing, but with flow state.  Actually, now that I'm thinking about it, maybe narrative transportation and flow state are the same?"

  Suddenly, he stops, scowls, and retracts the gold star.  "If they were the same, why would they need different names?  Have you seen a child engaged in a game?  Does it look @i{exactly} like a child engaged in a story?  Have you played a game?  Does that feel @i{exactly} like when you sit down in a movie theater?"
  ...
  Wondering what you got wrong, you peal off the three stars and hand them back.  Professor Istoria throws them into the trashcan beside his desk.  He rummages around and finds a fidget spinner and hands it to you.
  ...
  "The card seems to suggest that flow states increase motivation and self-directed learning, so I guess I would try to give my students as many flow state opportunities as possible.  Like educational video games and stuff."

  He doesn't answer.  He just wordlessly takes a gold star from his sheet and, instead of giving it to you, throws it into the trash.

  "I guess I would try gamifying my classroom, to make things fun.  Like, I would give out gold stars and fidget spinners ..."
  ...
  "With coding..." you say, causing him to pause his efforts to trash the gold star, "... I guess my goal is to induce flow states in which students are writing, reading, or editing code.  If it was a Spanish class, I suppose my goal would be to induce flow states in which students are speaking, reading, or writing in Spanish.  Languages take a @i{lot} of practice before you start recalling things effortlessly -- fluently."
